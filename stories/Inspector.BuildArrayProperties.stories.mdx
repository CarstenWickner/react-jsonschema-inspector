import { Canvas, Meta, Story, Props } from '@storybook/react';
...
<Meta title="Inspector (buildArrayProperties)" component={Inspector} />

# Inspector (buildArrayProperties)
## Focus: How to represent arrays in a Schema

<Props of={Inspector} exclude={Object.keys(Inspector.propTypes).filter(propName => propName !== "buildArrayProperties")} />
