...
<Meta title="Inspector (renderItemContent)" component={Inspector} />

# Inspector (renderItemContent)
## Focus: Customise item component

<Props of={Inspector} exclude={Object.keys(Inspector.propTypes).filter(propName => propName !== "renderItemContent")} />
